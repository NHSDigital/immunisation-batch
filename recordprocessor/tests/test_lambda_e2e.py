...
#     @staticmethod
#     def upload_files(sourc_file_content, mock_permissions=MOCK_PERMISSIONS):
...
#         # Test case tuples are stuctured as (test_name, index, expected_kinesis_data_ignoring_fhir_json,
# expect_success)
#         test_cases = [
