class Constant:
    ...
    def data_rows(status, created_at_formatted, message_header):
        ...
        if status is True:
            ...
            data_row = [message_header, 'fatal-error', 'error', 'error', 'business', '20005', 'Unsupported file type received as an attachment', created_at_formatted, 'TBC', 'DPS', True]  # noqa: E501
            return data_row
        elif status == "no permissions":
            data_row = [message_header, 'fatal-error', 'error', 'error', 'business', '20005', "No permissions for operation", created_at_formatted, 'TBC', 'DPS', False]
        else:
            data_row = [
                message_header,
                "fatal-error",
